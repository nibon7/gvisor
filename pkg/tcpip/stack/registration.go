...
type NetworkProtocol interface {
	...
	//
	// This function exists because there are situations where the decision
	// to send an ICP error is made by code that does not have insight
	// into ipv4 or ipv6 internals and does not need to know which
	// Network layer protocol is associated with the problematic packet.
