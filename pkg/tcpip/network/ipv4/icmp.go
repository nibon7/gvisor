...
// error packet for IPv4 and sends back to the remote device that sent the
// problematic packet. It incorporates as much of that packet as possible
// as well as any error metadata as is available. returnError
...
func returnError(r *stack.Route, reason icmpReason, pkt *stack.PacketBuffer) *tcpip.Error {
	...
	eType := header.ICMPv4DstUnreachable
