...
// It translates a protocol agnostic error into the IPv6 equivalent.
...
// The function isICMPReason is purely to stop it being an empty interface.
...
// returnError takes an error descriptor an dgnreates the appropriate ICMP error
// packet for IPv6 and sends it.
